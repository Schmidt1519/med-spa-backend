...
urlpatterns = [
    ...
    path('reviews/user/<int:user>/', views.ReviewUser.as_view()),
    path('memberships/', views.MembershipList.as_view()),
    path('memberships/<int:membership>/', views.MembershipDetail.as_view()),
    path('memberships/user/<int:user>/', views.MembershipByUser.as_view()),
    path('carts/', views.CartList.as_view()),
    path('carts/<int:user>/', views.CartDetail.as_view()),
